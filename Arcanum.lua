...
if host:isHost() then
    ...
    -- Функция для загрузки скриптов, доступных только хосту
    ...
    -- ======================
    local roleNames = {
        ["1460344907884527770"] = '[{"text":"Глава","color":"#71368a"}]',
        ["1460345014654599168"] = '[{"text":"Архонт","color":"#8b008b"}]',
        ["1460345349926551719"] = '[{"text":"Архимаг","color":"#9370db"}]',
        ["1460346401614463179"] = '[{"text":"Аркана","color":"#ff6347"}]',
        ["1460346580539412530"] = '[{"text":"Акколит","color":"#ff7f50"}]',
        ["1460346739176505537"] = '[{"text":"Аспирант","color":"#ffa07a"}]',
    }
